...
>[!NOTE]: I wanted to create a zed extension to accomplish this however after looking deeper into it i dont believe the extension API is robust enough to support the feature
